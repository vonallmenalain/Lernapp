...
const READING_WORD_ITEM_ADDITIONS = [
  wordItem("hase", "HASE", "der", "hare", "easy", "animal", ["HA", "SE"], ["missingLetter", "chooseWord", "sentenceMissingWord"]),
  wordItem("maus", "MAUS", "die", "mouse", "easy", "animal", ["MAUS"], ["missingLetter", "chooseWord", "sentenceMatch"]),
  wordItem("ente", "ENTE", "die", "duck", "easy", "animal", ["EN", "TE"], ["missingLetter", "chooseWord", "sentenceMatch", "sentenceMissingWord"]),
  wordItem("kuh", "KUH", "die", "cow", "easy", "animal", ["KUH"], ["missingLetter", "chooseWord", "sentenceMatch"]),
  wordItem("loewe", "LÖWE", "der", "lion", "easy", "animal", ["LÖ", "WE"], ["missingLetter", "chooseWord", "sentenceMatch"]),
  wordItem("igel", "IGEL", "der", "hedgehog", "easy", "animal", ["I", "GEL"], ["missingLetter", "chooseWord", "sentenceMatch"]),
  wordItem("wurm", "WURM", "der", "worm", "easy", "animal", ["WURM"], ["missingLetter", "chooseWord"]),
  wordItem("boot", "BOOT", "das", "boat", "easy", "vehicle", ["BOOT"], ["missingLetter", "chooseWord", "sentenceMatch"]),
  wordItem("zug", "ZUG", "der", "train", "easy", "vehicle", ["ZUG"], ["missingLetter", "chooseWord", "sentenceMatch", "sentenceMissingWord"]),
  wordItem("bus", "BUS", "der", "bus", "easy", "vehicle", ["BUS"], ["missingLetter", "chooseWord", "sentenceMatch"]),
  wordItem("hut", "HUT", "der", "hat", "easy", "clothing", ["HUT"], ["missingLetter", "chooseWord"]),
  wordItem("uhr", "UHR", "die", "clock", "easy", "thing", ["UHR"], ["missingLetter", "chooseWord", "sentenceMatch"]),
  wordItem("eis", "EIS", "das", "icecream", "easy", "food", ["EIS"], ["missingLetter", "chooseWord", "sentenceMissingWord"]),
  wordItem("brot", "BROT", "das", "bread", "easy", "food", ["BROT"], ["missingLetter", "chooseWord", "sentenceMatch"]),
  wordItem("milch", "MILCH", "die", "milk", "easy", "food", ["MILCH"], ["missingLetter", "chooseWord", "sentenceMatch", "sentenceMissingWord"]),
  wordItem("hand", "HAND", "die", "hand", "easy", "body", ["HAND"], ["missingLetter", "chooseWord", "sentenceMatch"]),
  wordItem("ohr", "OHR", "das", "ear", "easy", "body", ["OHR"], ["missingLetter", "chooseWord"]),
  wordItem("auge", "AUGE", "das", "eye", "easy", "body", ["AU", "GE"], ["missingLetter", "chooseWord", "sentenceMatch"]),
  wordItem("mund", "MUND", "der", "mouth", "easy", "body", ["MUND"], ["missingLetter", "chooseWord"]),
  wordItem("zahn", "ZAHN", "der", "tooth", "easy", "body", ["ZAHN"], ["missingLetter", "chooseWord"]),
  wordItem("bett", "BETT", "das", "bed", "easy", "thing", ["BETT"], ["missingLetter", "chooseWord", "sentenceMatch"]),
  wordItem("stuhl", "STUHL", "der", "chair", "easy", "thing", ["STUHL"], ["missingLetter", "chooseWord"]),
  wordItem("topf", "TOPF", "der", "pot", "easy", "thing", ["TOPF"], ["missingLetter", "chooseWord"]),
  wordItem("kamm", "KAMM", "der", "comb", "easy", "thing", ["KAMM"], ["missingLetter", "chooseWord"]),
  wordItem("ring", "RING", "der", "ring", "easy", "thing", ["RING"], ["missingLetter", "chooseWord"]),
  wordItem("nest", "NEST", "das", "nest", "easy", "nature", ["NEST"], ["missingLetter", "chooseWord"]),
  wordItem("blatt", "BLATT", "das", "leaf", "easy", "nature", ["BLATT"], ["missingLetter", "chooseWord", "sentenceMatch"]),
  wordItem("stein", "STEIN", "der", "stone", "easy", "nature", ["STEIN"], ["missingLetter", "chooseWord"]),
  wordItem("tuer", "TÜR", "die", "door", "easy", "thing", ["TÜR"], ["missingLetter", "chooseWord"]),
  wordItem("seil", "SEIL", "das", "rope", "easy", "thing", ["SEIL"], ["missingLetter", "chooseWord"]),
  wordItem("korb", "KORB", "der", "basket", "easy", "thing", ["KORB"], ["missingLetter", "chooseWord"]),
  wordItem("schaf", "SCHAF", "das", "sheep", "medium", "animal", ["SCHAF"], ["missingLetter", "chooseWord", "sentenceMatch"]),
  wordItem("ziege", "ZIEGE", "die", "goat", "medium", "animal", ["ZIE", "GE"], ["missingLetter", "chooseWord", "sentenceMatch"]),
  wordItem("pferd", "PFERD", "das", "horse", "medium", "animal", ["PFERD"], ["missingLetter", "chooseWord", "sentenceMatch", "sentenceMissingWord"]),
  wordItem("tiger", "TIGER", "der", "tiger", "medium", "animal", ["TI", "GER"], ["missingLetter", "chooseWord", "sentenceMatch"]),
  wordItem("zebra", "ZEBRA", "das", "zebra", "medium", "animal", ["ZE", "BRA"], ["missingLetter", "chooseWord"]),
  wordItem("biene", "BIENE", "die", "bee", "medium", "animal", ["BIE", "NE"], ["missingLetter", "chooseWord", "sentenceMatch", "sentenceMissingWord"]),
  wordItem("kaefer", "KÄFER", "der", "beetle", "medium", "animal", ["KÄ", "FER"], ["missingLetter", "chooseWord"]),
  wordItem("frosch", "FROSCH", "der", "frog", "medium", "animal", ["FROSCH"], ["missingLetter", "chooseWord", "sentenceMatch"]),
  wordItem("birne", "BIRNE", "die", "pear", "medium", "food", ["BIR", "NE"], ["missingLetter", "chooseWord", "sentenceMatch", "sentenceMissingWord"]),
  wordItem("gurke", "GURKE", "die", "cucumber", "medium", "food", ["GUR", "KE"], ["missingLetter", "chooseWord"]),
  wordItem("keks", "KEKS", "der", "cookie", "medium", "food", ["KEKS"], ["missingLetter", "chooseWord"]),
  wordItem("pizza", "PIZZA", "die", "pizza", "medium", "food", ["PIZ", "ZA"], ["missingLetter", "chooseWord", "sentenceMatch"]),
  wordItem("kaese", "KÄSE", "der", "cheese", "medium", "food", ["KÄ", "SE"], ["missingLetter", "chooseWord", "sentenceMissingWord"]),
  wordItem("butter", "BUTTER", "die", "butter", "medium", "food", ["BUT", "TER"], ["missingLetter", "chooseWord"]),
  wordItem("wasser", "WASSER", "das", "water", "medium", "food", ["WAS", "SER"], ["missingLetter", "chooseWord"]),
  wordItem("saft", "SAFT", "der", "juice", "medium", "food", ["SAFT"], ["missingLetter", "chooseWord"]),
  wordItem("loeffel", "LÖFFEL", "der", "spoon", "medium", "thing", ["LÖF", "FEL"], ["missingLetter", "chooseWord", "sentenceMatch"]),
  wordItem("messer", "MESSER", "das", "knife", "medium", "thing", ["MES", "SER"], ["missingLetter", "chooseWord"]),
  wordItem("sofa", "SOFA", "das", "sofa", "medium", "thing", ["SO", "FA"], ["missingLetter", "chooseWord"]),
  wordItem("kissen", "KISSEN", "das", "pillow", "medium", "thing", ["KIS", "SEN"], ["missingLetter", "chooseWord"]),
  wordItem("seife", "SEIFE", "die", "soap", "medium", "thing", ["SEI", "FE"], ["missingLetter", "chooseWord"]),
  wordItem("buerste", "BÜRSTE", "die", "brush", "medium", "thing", ["BÜRS", "TE"], ["missingLetter", "chooseWord"]),
  wordItem("muetze", "MÜTZE", "die", "cap", "medium", "clothing", ["MÜT", "ZE"], ["missingLetter", "chooseWord", "sentenceMatch"]),
  wordItem("hose", "HOSE", "die", "pants", "medium", "clothing", ["HO", "SE"], ["missingLetter", "chooseWord"]),
  wordItem("jacke", "JACKE", "die", "jacket", "medium", "clothing", ["JA", "CKE"], ["missingLetter", "chooseWord"]),
  wordItem("kleid", "KLEID", "das", "dress", "medium", "clothing", ["KLEID"], ["missingLetter", "chooseWord"]),
  wordItem("schal", "SCHAL", "der", "scarf", "medium", "clothing", ["SCHAL"], ["missingLetter", "chooseWord"]),
  wordItem("fahrrad", "FAHRRAD", "das", "bicycle", "medium", "vehicle", ["FAHR", "RAD"], ["missingLetter", "chooseWord", "sentenceMatch"]),
  wordItem("roller", "ROLLER", "der", "scooter", "medium", "vehicle", ["ROL", "LER"], ["missingLetter", "chooseWord", "sentenceMatch"]),
  wordItem("park", "PARK", "der", "park", "medium", "place", ["PARK"], ["missingLetter", "chooseWord", "sentenceMatch"]),
  wordItem("garten", "GARTEN", "der", "garden", "medium", "place", ["GAR", "TEN"], ["missingLetter", "chooseWord"]),
  wordItem("bruecke", "BRÜCKE", "die", "bridge", "medium", "place", ["BRÜ", "CKE"], ["missingLetter", "chooseWord", "sentenceMatch"]),
  wordItem("insel", "INSEL", "die", "island", "medium", "place", ["IN", "SEL"], ["missingLetter", "chooseWord"]),
  wordItem("tasche", "TASCHE", "die", "bag", "medium", "thing", ["TA", "SCHE"], ["missingLetter", "chooseWord", "sentenceMatch", "sentenceMissingWord"]),
  wordItem("krone", "KRONE", "die", "crown", "medium", "thing", ["KRO", "NE"], ["missingLetter", "chooseWord"]),
  wordItem("stern", "STERN", "der", "star", "medium", "nature", ["STERN"], ["missingLetter", "chooseWord"]),
  wordItem("heft", "HEFT", "das", "notebook", "medium", "thing", ["HEFT"], ["missingLetter", "chooseWord"]),
  wordItem("brief", "BRIEF", "der", "letter", "medium", "thing", ["BRIEF"], ["missingLetter", "chooseWord"]),
  wordItem("farbe", "FARBE", "die", "paint", "medium", "thing", ["FAR", "BE"], ["missingLetter", "chooseWord"]),
  wordItem("besen", "BESEN", "der", "broom", "medium", "thing", ["BE", "SEN"], ["missingLetter", "chooseWord"]),
  wordItem("eimer", "EIMER", "der", "bucket", "medium", "thing", ["EI", "MER"], ["missingLetter", "chooseWord"]),
  wordItem("saege", "SÄGE", "die", "saw", "medium", "thing", ["SÄ", "GE"], ["missingLetter", "chooseWord"]),
  wordItem("ananas", "ANANAS", "die", "pineapple", "hard", "food", ["A", "NA", "NAS"], ["missingLetter", "missingSyllable", "chooseWord"]),
  wordItem("karotte", "KAROTTE", "die", "carrot", "hard", "food", ["KA", "ROT", "TE"], ["missingLetter", "missingSyllable", "chooseWord", "sentenceMissingWord", "sentenceMatch"]),
  wordItem("paprika", "PAPRIKA", "die", "bell_pepper", "hard", "food", ["PA", "PRI", "KA"], ["missingLetter", "missingSyllable", "chooseWord"]),
  wordItem("erdbeere", "ERDBEERE", "die", "strawberry", "hard", "food", ["ERD", "BEE", "RE"], ["missingLetter", "missingSyllable", "chooseWord"]),
  wordItem("kartoffel", "KARTOFFEL", "die", "potato", "hard", "food", ["KAR", "TOF", "FEL"], ["missingLetter", "missingSyllable", "chooseWord"]),
  wordItem("kirsche", "KIRSCHE", "die", "cherries", "hard", "food", ["KIR", "SCHE"], ["missingLetter", "missingSyllable", "chooseWord"]),
  wordItem("marmelade", "MARMELADE", "die", "jam", "hard", "food", ["MAR", "ME", "LA", "DE"], ["missingSyllable", "chooseWord"]),
  wordItem("dinosaurier", "DINOSAURIER", "der", "dinosaur", "hard", "animal", ["DI", "NO", "SAU", "RIER"], ["missingSyllable", "chooseWord"]),
  wordItem("pinguin", "PINGUIN", "der", "penguin", "hard", "animal", ["PIN", "GU", "IN"], ["missingLetter", "missingSyllable", "chooseWord", "sentenceMatch"]),
  wordItem("hamster", "HAMSTER", "der", "hamster", "hard", "animal", ["HAMS", "TER"], ["missingLetter", "missingSyllable", "chooseWord", "sentenceMatch"]),
  wordItem("kaninchen", "KANINCHEN", "das", "rabbit", "hard", "animal", ["KA", "NIN", "CHEN"], ["missingLetter", "missingSyllable", "chooseWord"]),
  wordItem("eichhoernchen", "EICHHÖRNCHEN", "das", "squirrel", "hard", "animal", ["EICH", "HÖRN", "CHEN"], ["missingSyllable", "chooseWord"]),
  wordItem("marienkaefer", "MARIENKÄFER", "der", "lady_beetle", "hard", "animal", ["MA", "RI", "EN", "KÄ", "FER"], ["missingSyllable", "chooseWord"]),
  wordItem("schildkroete", "SCHILDKRÖTE", "die", "turtle", "hard", "animal", ["SCHILD", "KRÖ", "TE"], ["missingSyllable", "chooseWord", "sentenceMatch"]),
  wordItem("nilpferd", "NILPFERD", "das", "hippo", "hard", "animal", ["NIL", "PFERD"], ["missingLetter", "missingSyllable", "chooseWord"]),
  wordItem("wasserfall", "WASSERFALL", "der", "waterfall", "hard", "nature", ["WAS", "SER", "FALL"], ["missingSyllable", "chooseWord"]),
  wordItem("regenbogen", "REGENBOGEN", "der", "rainbow", "hard", "nature", ["RE", "GEN", "BO", "GEN"], ["missingSyllable", "chooseWord", "sentenceMatch", "sentenceMissingWord"]),
  wordItem("schneeflocke", "SCHNEEFLOCKE", "die", "snowflake", "hard", "nature", ["SCHNEE", "FLO", "CKE"], ["missingSyllable", "chooseWord"]),
  wordItem("sandburg", "SANDBURG", "die", "sandcastle", "hard", "thing", ["SAND", "BURG"], ["missingLetter", "missingSyllable", "chooseWord"]),
  wordItem("kastanie", "KASTANIE", "die", "chestnut", "hard", "nature", ["KAS", "TA", "NIE"], ["missingLetter", "missingSyllable", "chooseWord"]),
  wordItem("laterne", "LATERNE", "die", "lantern", "hard", "thing", ["LA", "TER", "NE"], ["missingLetter", "missingSyllable", "chooseWord", "sentenceMatch", "sentenceMissingWord"]),
  wordItem("turnschuh", "TURNSCHUH", "der", "sneaker", "hard", "thing", ["TURN", "SCHUH"], ["missingLetter", "missingSyllable", "chooseWord"]),
  wordItem("zahnbuerste", "ZAHNBÜRSTE", "die", "toothbrush", "hard", "thing", ["ZAHN", "BÜRS", "TE"], ["missingSyllable", "chooseWord"]),
  wordItem("spielplatz", "SPIELPLATZ", "der", "playground", "hard", "place", ["SPIEL", "PLATZ"], ["missingSyllable", "chooseWord"]),
  wordItem("krankenhaus", "KRANKENHAUS", "das", "hospital", "hard", "place", ["KRAN", "KEN", "HAUS"], ["missingSyllable", "chooseWord"]),
  wordItem("supermarkt", "SUPERMARKT", "der", "supermarket", "hard", "place", ["SU", "PER", "MARKT"], ["missingSyllable", "chooseWord"]),
  wordItem("feuerwehr", "FEUERWEHR", "die", "fire_engine", "hard", "vehicle", ["FEU", "ER", "WEHR"], ["missingSyllable", "chooseWord"]),
  wordItem("polizei", "POLIZEI", "die", "police", "hard", "vehicle", ["PO", "LI", "ZEI"], ["missingLetter", "missingSyllable", "chooseWord"]),
  wordItem("bahnhof", "BAHNHOF", "der", "station", "hard", "place", ["BAHN", "HOF"], ["missingLetter", "missingSyllable", "chooseWord"]),
  wordItem("flugzeug", "FLUGZEUG", "das", "airplane", "hard", "vehicle", ["FLUG", "ZEUG"], ["missingLetter", "missingSyllable", "chooseWord", "sentenceMatch", "sentenceMissingWord"]),
  wordItem("hubschrauber", "HUBSCHRAUBER", "der", "helicopter", "hard", "vehicle", ["HUB", "SCHRAU", "BER"], ["missingSyllable", "chooseWord"]),
  wordItem("traktor", "TRAKTOR", "der", "tractor", "hard", "vehicle", ["TRAK", "TOR"], ["missingLetter", "missingSyllable", "chooseWord", "sentenceMatch"]),
  wordItem("bagger", "BAGGER", "der", "excavator", "hard", "vehicle", ["BAG", "GER"], ["missingLetter", "missingSyllable", "chooseWord"]),
  wordItem("schaukel", "SCHAUKEL", "die", "swing", "hard", "thing", ["SCHAU", "KEL"], ["missingLetter", "missingSyllable", "chooseWord"]),
  wordItem("rutsche", "RUTSCHE", "die", "slide", "hard", "thing", ["RUT", "SCHE"], ["missingLetter", "missingSyllable", "chooseWord"]),
  wordItem("trommel", "TROMMEL", "die", "drum", "hard", "thing", ["TROM", "MEL"], ["missingLetter", "missingSyllable", "chooseWord", "sentenceMatch"]),
  wordItem("gitarre", "GITARRE", "die", "guitar", "hard", "thing", ["GI", "TAR", "RE"], ["missingLetter", "missingSyllable", "chooseWord", "sentenceMatch", "sentenceMissingWord"]),
  wordItem("klavier", "KLAVIER", "das", "piano", "hard", "thing", ["KLA", "VIER"], ["missingLetter", "missingSyllable", "chooseWord"]),
  wordItem("computer", "COMPUTER", "der", "computer", "hard", "thing", ["COM", "PU", "TER"], ["missingLetter", "missingSyllable", "chooseWord", "sentenceMatch"]),
  wordItem("telefon", "TELEFON", "das", "phone", "hard", "thing", ["TE", "LE", "FON"], ["missingLetter", "missingSyllable", "chooseWord", "sentenceMatch"]),
  wordItem("kamera", "KAMERA", "die", "camera", "hard", "thing", ["KA", "ME", "RA"], ["missingLetter", "missingSyllable", "chooseWord", "sentenceMatch"]),
  wordItem("schluessel", "SCHLÜSSEL", "der", "key", "hard", "thing", ["SCHLÜS", "SEL"], ["missingSyllable", "chooseWord", "sentenceMatch", "sentenceMissingWord"]),
  wordItem("fernseher", "FERNSEHER", "der", "tv", "hard", "thing", ["FERN", "SE", "HER"], ["missingSyllable", "chooseWord"]),
  wordItem("schokolade", "SCHOKOLADE", "die", "chocolate", "hard", "food", ["SCHO", "KO", "LA", "DE"], ["missingSyllable", "chooseWord"]),
  wordItem("pfannkuchen", "PFANNKUCHEN", "der", "pancakes", "hard", "food", ["PFANN", "KU", "CHEN"], ["missingSyllable", "chooseWord"]),
  wordItem("geburtstag", "GEBURTSTAG", "der", "birthday", "hard", "thing", ["GE", "BURTS", "TAG"], ["missingSyllable", "chooseWord"]),
];
const READING_IMAGE_MAP_ADDITIONS = {
  hare: "🐇", mouse: "🐭", duck: "🦆", cow: "🐄",
  lion: "🦁", hedgehog: "🦔", worm: "🪱", boat: "⛵",
  train: "🚆", bus: "🚌", hat: "🎩", clock: "⏰",
  icecream: "🍦", bread: "🍞", milk: "🥛", hand: "✋",
  ear: "👂", eye: "👁️", mouth: "👄", tooth: "🦷",
  bed: "🛏️", chair: "🪑", pot: "🥘", comb: "🪮",
  ring: "💍", nest: "🪹", leaf: "🍃", stone: "🪨",
  door: "🚪", rope: "🪢", basket: "🧺", sheep: "🐑",
  goat: "🐐", horse: "🐴", tiger: "🐯", zebra: "🦓",
  bee: "🐝", beetle: "🪲", frog: "🐸", pear: "🍐",
  cucumber: "🥒", cookie: "🍪", pizza: "🍕", cheese: "🧀",
  butter: "🧈", water: "💧", juice: "🧃", spoon: "🥄",
  knife: "🔪", sofa: "🛋️", pillow: "🛏️", soap: "🧼",
  brush: "🪥", cap: "🧢", pants: "👖", jacket: "🧥",
  dress: "👗", scarf: "🧣", bicycle: "🚲", scooter: "🛴",
  park: "🏞️", garden: "🪴", bridge: "🌉", island: "🏝️",
  bag: "👝", crown: "👑", star: "⭐", notebook: "📓",
  letter: "✉️", paint: "🎨", broom: "🧹", bucket: "🪣",
  saw: "🪚", pineapple: "🍍", carrot: "🥕", bell_pepper: "🫑",
  strawberry: "🍓", potato: "🥔", cherries: "🍒", jam: "🍯",
  dinosaur: "🦕", penguin: "🐧", hamster: "🐹", rabbit: "🐰",
  squirrel: "🐿️", lady_beetle: "🐞", turtle: "🐢", hippo: "🦛",
  waterfall: "🏞️💧", rainbow: "🌈", snowflake: "❄️", sandcastle: "🏖️",
  chestnut: "🌰", lantern: "🏮", sneaker: "👟", toothbrush: "🪥",
  playground: "🛝", hospital: "🏥", supermarket: "🛒", fire_engine: "🚒",
  police: "🚓", station: "🚉", airplane: "✈️", helicopter: "🚁",
  tractor: "🚜", excavator: "🏗️", swing: "🛝", slide: "🛝",
  drum: "🥁", guitar: "🎸", piano: "🎹", computer: "💻",
  phone: "📞", camera: "📷", key: "🔑", tv: "📺",
  chocolate: "🍫", pancakes: "🥞", birthday: "🎂", duck_swimming: "🦆💧",
  cow_grass: "🐄🌱", hand_wave: "👋", blue_cap: "🧢", mouse_cheese: "🐭🧀",
  child_milk: "🧒🥛",
};
const READING_EXTRA_DISTRACTOR_ADDITIONS = ["MAUS", "ENTE", "KUH", "LÖWE", "IGEL", "WURM", "ZUG", "BUS", "HUT", "UHR", "EIS", "BROT", "MILCH", "OHR", "AUGE", "MUND", "ZAHN", "STUHL", "TOPF", "KAMM", "RING", "NEST", "BLATT", "STEIN", "TÜR", "SEIL", "KORB", "SCHAF", "ZIEGE", "PFERD", "TIGER", "ZEBRA", "BIENE", "KÄFER", "GURKE", "KEKS", "PIZZA", "KÄSE", "BUTTER", "WASSER", "SAFT", "LÖFFEL", "MESSER", "SOFA", "KISSEN", "SEIFE", "BÜRSTE", "MÜTZE", "HOSE", "JACKE", "KLEID", "SCHAL", "FAHRRAD", "ROLLER", "PARK", "GARTEN", "BRÜCKE", "INSEL", "TASCHE", "KRONE", "STERN", "HEFT", "BRIEF", "FARBE", "BESEN", "EIMER", "SÄGE", "ANANAS", "KAROTTE", "PAPRIKA", "ERDBEERE", "KARTOFFEL", "KIRSCHE", "MARMELADE", "PINGUIN", "HAMSTER", "KANINCHEN", "NILPFERD", "REGENBOGEN", "LATERNE", "TRAKTOR", "BAGGER", "TROMMEL", "GITARRE", "KLAVIER", "COMPUTER", "TELEFON", "KAMERA", "SCHLÜSSEL"];
const READING_SENTENCE_ITEM_ADDITIONS = [
  { id: "maus-frisst", sentence: "Die Maus frisst.", imageKey: "mouse", correctWordIds: ["maus"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "ente-schwimmt", sentence: "Die Ente schwimmt.", imageKey: "duck_swimming", correctWordIds: ["ente"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "kuh-frisst-gras", sentence: "Die Kuh frisst Gras.", imageKey: "cow_grass", correctWordIds: ["kuh"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "loewe-bruellt", sentence: "Der Löwe brüllt.", imageKey: "lion", correctWordIds: ["loewe"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "igel-schlaeft", sentence: "Der Igel schläft.", imageKey: "hedgehog", correctWordIds: ["igel"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "boot-schwimmt", sentence: "Das Boot schwimmt.", imageKey: "boat", correctWordIds: ["boot"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "zug-faehrt", sentence: "Der Zug fährt.", imageKey: "train", correctWordIds: ["zug"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "bus-faehrt", sentence: "Der Bus fährt.", imageKey: "bus", correctWordIds: ["bus"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "uhr-klingelt", sentence: "Die Uhr klingelt.", imageKey: "clock", correctWordIds: ["uhr"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "brot-liegt", sentence: "Das Brot liegt da.", imageKey: "bread", correctWordIds: ["brot"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "milch-steht", sentence: "Die Milch steht da.", imageKey: "milk", correctWordIds: ["milch"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "hand-winkt", sentence: "Die Hand winkt.", imageKey: "hand_wave", correctWordIds: ["hand"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "auge-sieht", sentence: "Das Auge sieht.", imageKey: "eye", correctWordIds: ["auge"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "bett-ist-weich", sentence: "Das Bett ist weich.", imageKey: "bed", correctWordIds: ["bett"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "blatt-faellt", sentence: "Das Blatt fällt.", imageKey: "leaf", correctWordIds: ["blatt"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "schaf-frisst", sentence: "Das Schaf frisst.", imageKey: "sheep", correctWordIds: ["schaf"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "ziege-klettert", sentence: "Die Ziege klettert.", imageKey: "goat", correctWordIds: ["ziege"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "pferd-rennt", sentence: "Das Pferd rennt.", imageKey: "horse", correctWordIds: ["pferd"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "tiger-schleicht", sentence: "Der Tiger schleicht.", imageKey: "tiger", correctWordIds: ["tiger"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "biene-fliegt", sentence: "Die Biene fliegt.", imageKey: "bee", correctWordIds: ["biene"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "frosch-springt", sentence: "Der Frosch springt.", imageKey: "frog", correctWordIds: ["frosch"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "birne-gruen", sentence: "Die Birne ist grün.", imageKey: "pear", correctWordIds: ["birne"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "pizza-rund", sentence: "Die Pizza ist rund.", imageKey: "pizza", correctWordIds: ["pizza"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "loeffel-liegt", sentence: "Der Löffel liegt da.", imageKey: "spoon", correctWordIds: ["loeffel"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "muetze-blau", sentence: "Die Mütze ist blau.", imageKey: "blue_cap", correctWordIds: ["muetze"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "fahrrad-faehrt", sentence: "Das Fahrrad fährt.", imageKey: "bicycle", correctWordIds: ["fahrrad"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "roller-rollt", sentence: "Der Roller rollt.", imageKey: "scooter", correctWordIds: ["roller"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "park-gruen", sentence: "Der Park ist grün.", imageKey: "park", correctWordIds: ["park"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "bruecke-lang", sentence: "Die Brücke ist lang.", imageKey: "bridge", correctWordIds: ["bruecke"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "tasche-voll", sentence: "Die Tasche ist voll.", imageKey: "bag", correctWordIds: ["tasche"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "karotte-orange", sentence: "Die Karotte ist orange.", imageKey: "carrot", correctWordIds: ["karotte"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "pinguin-watschelt", sentence: "Der Pinguin watschelt.", imageKey: "penguin", correctWordIds: ["pinguin"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "hamster-frisst", sentence: "Der Hamster frisst.", imageKey: "hamster", correctWordIds: ["hamster"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "schildkroete-kriecht", sentence: "Die Schildkröte kriecht.", imageKey: "turtle", correctWordIds: ["schildkroete"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "regenbogen-leuchtet", sentence: "Der Regenbogen leuchtet.", imageKey: "rainbow", correctWordIds: ["regenbogen"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "laterne-leuchtet", sentence: "Die Laterne leuchtet.", imageKey: "lantern", correctWordIds: ["laterne"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "flugzeug-fliegt", sentence: "Das Flugzeug fliegt.", imageKey: "airplane", correctWordIds: ["flugzeug"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "traktor-faehrt", sentence: "Der Traktor fährt.", imageKey: "tractor", correctWordIds: ["traktor"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "trommel-klingt", sentence: "Die Trommel klingt.", imageKey: "drum", correctWordIds: ["trommel"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "gitarre-klingt", sentence: "Die Gitarre klingt.", imageKey: "guitar", correctWordIds: ["gitarre"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "computer-startet", sentence: "Der Computer startet.", imageKey: "computer", correctWordIds: ["computer"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "telefon-klingelt", sentence: "Das Telefon klingelt.", imageKey: "phone", correctWordIds: ["telefon"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "kamera-blitzt", sentence: "Die Kamera blitzt.", imageKey: "camera", correctWordIds: ["kamera"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "schluessel-passt", sentence: "Der Schlüssel passt.", imageKey: "key", correctWordIds: ["schluessel"], difficulty: "extreme", taskTypes: ["sentenceMatch"] },
  { id: "maus-frisst-kaese", sentence: "Die Maus frisst Käse.", prompt: "Die Maus frisst ___.", imageKey: "mouse_cheese", correctWordId: "kaese", difficulty: "extreme", taskTypes: ["sentenceMissingWord"] },
  { id: "hase-springt", sentence: "Der Hase springt.", prompt: "Der ___ springt.", imageKey: "hare", correctWordId: "hase", difficulty: "extreme", taskTypes: ["sentenceMissingWord"] },
  { id: "kind-trinkt-milch", sentence: "Das Kind trinkt Milch.", prompt: "Das Kind trinkt ___.", imageKey: "child_milk", correctWordId: "milch", difficulty: "extreme", taskTypes: ["sentenceMissingWord"] },
  { id: "ich-esse-eis", sentence: "Ich esse ein Eis.", prompt: "Ich esse ein ___.", imageKey: "icecream", correctWordId: "eis", difficulty: "extreme", taskTypes: ["sentenceMissingWord"] },
  { id: "der-zug-faehrt", sentence: "Der Zug fährt.", prompt: "Der ___ fährt.", imageKey: "train", correctWordId: "zug", difficulty: "extreme", taskTypes: ["sentenceMissingWord"] },
  { id: "die-ente-schwimmt", sentence: "Die Ente schwimmt.", prompt: "Die ___ schwimmt.", imageKey: "duck_swimming", correctWordId: "ente", difficulty: "extreme", taskTypes: ["sentenceMissingWord"] },
  { id: "das-pferd-rennt", sentence: "Das Pferd rennt.", prompt: "Das ___ rennt.", imageKey: "horse", correctWordId: "pferd", difficulty: "extreme", taskTypes: ["sentenceMissingWord"] },
  { id: "die-biene-fliegt", sentence: "Die Biene fliegt.", prompt: "Die ___ fliegt.", imageKey: "bee", correctWordId: "biene", difficulty: "extreme", taskTypes: ["sentenceMissingWord"] },
  { id: "die-birne-gruen", sentence: "Die Birne ist grün.", prompt: "Die ___ ist grün.", imageKey: "pear", correctWordId: "birne", difficulty: "extreme", taskTypes: ["sentenceMissingWord"] },
  { id: "karotte-ist-orange", sentence: "Die Karotte ist orange.", prompt: "Die ___ ist orange.", imageKey: "carrot", correctWordId: "karotte", difficulty: "extreme", taskTypes: ["sentenceMissingWord"] },
  { id: "die-laterne-leuchtet", sentence: "Die Laterne leuchtet.", prompt: "Die ___ leuchtet.", imageKey: "lantern", correctWordId: "laterne", difficulty: "extreme", taskTypes: ["sentenceMissingWord"] },
  { id: "das-flugzeug-fliegt", sentence: "Das Flugzeug fliegt.", prompt: "Das ___ fliegt.", imageKey: "airplane", correctWordId: "flugzeug", difficulty: "extreme", taskTypes: ["sentenceMissingWord"] },
  { id: "die-gitarre-klingt", sentence: "Die Gitarre klingt.", prompt: "Die ___ klingt.", imageKey: "guitar", correctWordId: "gitarre", difficulty: "extreme", taskTypes: ["sentenceMissingWord"] },
  { id: "der-schluessel-passt", sentence: "Der Schlüssel passt.", prompt: "Der ___ passt.", imageKey: "key", correctWordId: "schluessel", difficulty: "extreme", taskTypes: ["sentenceMissingWord"] },
  { id: "der-regenbogen-leuchtet", sentence: "Der Regenbogen leuchtet.", prompt: "Der ___ leuchtet.", imageKey: "rainbow", correctWordId: "regenbogen", difficulty: "extreme", taskTypes: ["sentenceMissingWord"] },
  { id: "die-tasche-voll", sentence: "Die Tasche ist voll.", prompt: "Die ___ ist voll.", imageKey: "bag", correctWordId: "tasche", difficulty: "extreme", taskTypes: ["sentenceMissingWord"] },
];
READING_WORD_ITEMS.push(...READING_WORD_ITEM_ADDITIONS);
Object.assign(READING_IMAGE_MAP, READING_IMAGE_MAP_ADDITIONS);
READING_EXTRA_DISTRACTOR_ADDITIONS.forEach((word) => { if (!READING_EXTRA_DISTRACTORS.includes(word)) READING_EXTRA_DISTRACTORS.push(word); });
READING_SENTENCE_ITEMS.push(...READING_SENTENCE_ITEM_ADDITIONS);
